...
def get_fastest_compound(lap, gp, session, year):
    plotting.setup_mpl()
    ...
    laps = laps.loc[laps['RaceLapNumber'] == int(lap)]
    # lap = laps.loc[laps['LapNumber'] == int(lap)]
    ...
    generate_minisector_plot(lap, telemetry)


def generate_minisector_plot(lap, telemetry, save=False, details=True):
