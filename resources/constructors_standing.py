...
from helpers.ergast_api_helper import get_current_constructors_standing
from helpers.handle_endpoint_exception import handle_endpoint_exception


class ConstructorsStanding(Resource):
    def get(self):
        try:
            return jsonify(get_current_constructors_standing())
